      ...
      <div className="max-w-7xl mx-auto cursor-pointer">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto font-roboto font-light leading-relaxed">
            Discover expertly curated guided tours to the world&apos;s most captivating destinations.
            Let our experienced guides lead the way to unforgettable adventures.
          </p>
        </motion.div>
...
export default GuidedTourOffers