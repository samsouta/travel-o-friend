...
const destinations: Destination[] = [
  ...
  },
  {
    ...
    packageName: "Paradisus Los Cabos - Adults Only | Air & Vacation Package",
    duration: "4 nights",
    price: "$1,315",
    rating: 4,
  ...
  },
  {
    ...
    region: "Caribbean",
    packageName: "Dreams® Playa Esmeralda Resort & Spa | Air & Vacation Package",
    duration: "4 nights",
    price: "$1,315",
    rating: 4,
  ...
  },
  {
    ...
    country: "Bahamas",
    region: "Caribbean",
    packageName: "Riu Palace Paradise Island | Air & Vacation Package",
    duration: "4 nights",
    price: "$1,295",
    rating: 4,
    image: "https://ik.imagekit.io/deceuior6/Travel%20O%20friend/Bora%20Bora%20Polynesia%20(Photo%20credit%20to%20IG%20braybraywoowoo)%20_beautiful%20_awesome%20_great%20_dayobamidele.jpeg?updatedAt=1757723480467",
    gradient: "from-slate-800 to-slate-600",
    icons: ["plane", "hotel", "coffee"]
  },
  {
    ...
    country: "Dominican Republic",
    region: "Caribbean",
    packageName: "Majestic Elegance Punta Cana | Air & Vacation Package",
    duration: "4 nights",
    price: "$1,229",
    originalPrice: "$1,429",
    rating: 4,
  ...
  },
  {
    ...
    country: "Jamaica",
    region: "Caribbean",
    packageName: "Sandals Dunn's River | Air & Vacation Package",
    duration: "4 nights",
    price: "$2,429",
    originalPrice: "$2,729",
    rating: 4,
    ...
    <section className="py-16 px-4 bg-gradient-to-br from-blue-50 via-white to-cyan-50 min-h-screen">
      <div className="max-w-7xl mx-auto cursor-pointer">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto font-roboto font-light leading-relaxed">
            Seeking inspiration for your next getaway? Explore these beloved destinations 
            that our clients recommend time and again.
          </p>
        </motion.div>
